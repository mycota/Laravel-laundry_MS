...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header" style="background-color: #008B8B;; color: white; border: 1px solid pink;"></div>
                ...
                <div class="card-body" style="border: 1px solid #008B8B; box-shadow: 14px 12px 8px gray;">
                    <form method="POST" enctype="multipart/form-data" action="{{ route('admin.users.updateuser', $user->id) }}">
                        @csrf
                        {{ method_field('POST')}}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="emplydate" type="date" class="form-control @error('emplydate') is-invalid @enderror" name="emplydate" value="{{ old('emplydate') ?? $user->emplydate }}" required autocomplete="emplydate" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="bod" type="text" class="form-control @error('salary') is-invalid @enderror" name="salary" value="{{ old('salary') ?? $user->salary}}" required autocomplete="salary" autofocus>

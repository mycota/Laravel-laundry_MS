        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header" style="background-color: #008B8B;; color: white; border: 1px solid pink;">Profile</div>
                	...
                	@if($user->image)
                		<div class="media">
			    		<img class="rounded-circle account-img" src="public/storage/{{ $user->image}}" alt="Not showing, but it there" class="img-thumbnail">
			    	</div>
			    	@else
			    		<div class="media">
			    		<img class="rounded-circle account-img" src="{{ asset('storage/default.png') }}" alt="Not showing default image" class="img-thumbnail">
			    	</div>
			    	@endif
                ...
                <div class="card-body" style="border: 1px solid #008B8B; box-shadow: 14px 12px 8px gray;">
                    <form method="POST" enctype="multipart/form-data" action="{{ route('auth.update', $user->id) }}">
                        @csrf
                        {{ method_field('PUT')}}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea id="address" type="text" class="form-control @error('address') is-invalid @enderror" name="address" value="{{ old('address') ?? $user->address }}" required autocomplete="address" autofocus></textarea>

...
<div class="container" >
    <div class="row justify-content-center" >
        <div class="col-md-12" >
            <div class="card">
                <div class="card-header" style="background-color: #FF7F50; color: white; border: 1px solid black;">Update machine</div>

                <div class="card-body" style="border: 1px solid #FF7F50; box-shadow: 14px 12px 8px gray;">
                    <form method="POST" enctype="multipart/form-data" action="{{ route('wmachines.update', $machine->id) }}">
                        @csrf
                        {{ method_field('PATCH')}}
                        <fieldset><center><legend>Update machine</legend></center><hr>
